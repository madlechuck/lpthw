...
current_line += 1  #  Changes the variable current_line from 1 to 2, using a +1.
...
current_line += 1 # Changes the variable current_line from 2 to 3, using a +1 once again.
